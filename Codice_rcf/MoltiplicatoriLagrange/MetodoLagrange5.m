...
%Disegno i punti in cui si è arrestao il Metodo di Newton
set(0,'CurrentFigure',fig1);
plot(x(:,1),x(:,2),'or','MarkerSize',5,'MarkerFaceColor','r')
...
if( isempty(Soluzione)==0)
    plot(Soluzione(:,1),Soluzione(:,2),'ob','MarkerSize',5,'MarkerFaceColor','b')   
end
