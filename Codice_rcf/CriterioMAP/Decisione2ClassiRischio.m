% Problema di Decisione a 2 classi basato sul criterio Minimio Rischio Condizionale,
...
%
% Vediamo che il Criterio Minimio Rischio Condizionale conduce allo stesso
% problema di Minimizzare la Probabilità di Errore
clear;clc;
A=[0 1;
   1 0];
%
