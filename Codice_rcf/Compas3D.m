% function Compas3D(x,y,z)
% Disegna un vettore in R3 di cordinate (x,y,z) applicato in (0,0,0)
%
% author: Giorgio Gemignani

function Compas3D(x,y,z,colore)
...
surf(Xnew+Pstart(1),Ynew+Pstart(2),Znew+Pstart(3),'EdgeColor',colore);%,'EdgeColor',colore
patch(Xnew(1,:)+Pstart(1),Ynew(1,:)+Pstart(2),Znew(1,:)+Pstart(3),colore)
view(3);
box;
grid on;
