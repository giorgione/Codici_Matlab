...
% Verosimiglianze distribuzioni Gaussiana 2-d.
% Le distribuzioni di Verosimiglianza sono distribuzioni gaussiane con la
% STESSA MATRICE DI VARIANZA-COVARIANZA -> Sc1=Sc2=Sc3=Sc4 = S 
%
% Procedimento:
%
...
%          i
%
w=inv(S)*[Mc1 Mc2 Mc3 Mc4];

wo=(-1/2)*[Mc1.'*inv(S)*Mc1+log(Pc1)
           Mc2.'*inv(S)*Mc2+log(Pc2)
           Mc3.'*inv(S)*Mc3+log(Pc3)
           Mc4.'*inv(S)*Mc4+log(Pc4)];

%nb: Essendo le Distribuzioni di Verosimiglianza Gaussiane il 99% dei dati dovrebbero 
%    concentrarsi attorno alla media di ogni cluster entro 3*sgrt(ro).
%    I dati che sono fuori da questo intervallo sono anomali..
