...
% Probabilità ha integrale uguale ad 1
...
%Verifico che l'integrale di rettangolo((x-5)/5,5)/Vn è uguale ad 1:
% ho normalizzato
...
hn=5;
%Verifico che l'integrale di Pn è 1: Pn è una distribuzione di Probabilità
