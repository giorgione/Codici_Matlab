%Clustering a minima distanza ITERATIVO su un SET di DATI 1-D
...
a=min(Dati);
 ...
 title('Dati Clusterizzati : secondo una configurazione iniziale casuale');
 ...
 plot(D2,0,'ob','MarkerSize',2,'MarkerFaceColor','b');
 plot(U(2,2),0,'ob','MarkerSize',4,'MarkerFaceColor','g')
 title('Dati Clusterizzati Mediante Procedura Iterativa a Minima Distanza')
