...
Theta0=zeros(NVar,NPuntiIniziali);
 %Punto Iniziale
Theta0(1,:) = linspace(5,25 , NPuntiIniziali );
Theta0(2,:) = linspace( 5 , 25 , NPuntiIniziali); 
...
%             subplot( 2,1,2 );
            ...
            fprintf(FID, '%d & %8.2f %8.2f & %8.2f & %8.2f & %8.2f & %8.2f \\\\  \\hline',i,Samples(1,i) ,Samples(2,i), a(k),b(k),Ac/T , 1-Ac/T);
            if i==length(K)
                fprintf(FID, '\\hline ');
            end
            fprintf(FID, '\n');
