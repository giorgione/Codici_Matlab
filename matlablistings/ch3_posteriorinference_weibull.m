%% Chapter 3. Use Metropolis-Hastings procedure 
%  to estimate parameters in Weibull example 
...
%Disegno la Distibuzione a Masimma Verosimiglianza
x=linspace( ymin , ymax , 100 );
plot(x , wblpdf(x,Ml_params(1),Ml_params(2) ), 'g-' , 'LineWidth' , 2); hold on;
